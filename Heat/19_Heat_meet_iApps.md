...
####You can basically do any L4-L7 configuration of your BIG-IP if you take the time to write a declarative iApp and then use the F5 Heat resources to orchestrate them into the infrastructure!
